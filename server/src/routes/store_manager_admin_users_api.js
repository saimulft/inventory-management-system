...
const run = async () => {
    ...
    router.post('/create_store_manager_admin', async (req, res) => {
        try {
            ...
            const result = await store_manager_admin_users_collection.insertOne(store_manager_admin_user_data)
                ...
                if (response.acknowledged) {
                    const send_email_data = {
                        ...
                        <div class="container">
                            ...
                            <p>To verify your email <a href="http://localhost:5173/verify_email?id=${req.body.store_manager_admin_id}">Click here</a></p>
                        </div>`
                    }
