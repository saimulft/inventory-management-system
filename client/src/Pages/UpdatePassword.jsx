...
const UpdatePassword = () => {
    ...
    const { mutateAsync, isLoading } = useMutation({
        mutationFn: (passowrd) => {
            return axios.post('/api/v1/authentication_api/reset_password', passowrd)
        },
    })
            ...
            <div className="border border-[#8633FF] h-fit w-fit m-auto rounded-xl">
                <div className="lg:py-20 lg:px-28 p-10 max-w-[700px] w-[600px]">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <div>
                            {successMessage && <p className="w-full flex gap-2 items-center justify-center text-center text-sm mt-5 font-medium text-green-600 bg-green-100 border py-2 px-4 rounded"><BsCheck2Circle size={28} /> {successMessage}</p>}
