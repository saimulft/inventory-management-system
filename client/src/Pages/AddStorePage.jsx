        ...
        <div className="lg:py-20 lg:px-28 p-10">
          <form>
            ...
            <div className="flex flex-col mt-4">
              ...
              <input type="text" placeholder="Enter store name" className="input input-bordered input-primary w-full max-w-xs mt-2" id="storeName" name="storeName" />
            </div>

            <div className="flex flex-col mt-2">
              <label className="text-slate-500">Store name*</label>
              <input type="text" placeholder="Enter store manager name" className="input input-bordered input-primary w-full max-w-xs mt-2" id="storeManagerName" name="storeManagerName" />
            </div>
