...
export default function Sidebar() {
  ...
  return (
    <div
      className={`sticky bottom-0 top-0 pt-8 bg-[#081229] ${
    ...
    >
      <div>
        <div
          ...
          className={`border  w-8 h-8 rounded-full transition-all duration-500 ${
        ...
        <div className=" flex flex-col justify-between w-full h-[calc(100vh-100px)] mx-auto items-center mt-10 relative">
          ...
          <div className="space-y-2 ">
            <div
              className={`bg-[#8633FF] text-white  ${
                isSidebarOpen ? "ps-2 pe-4 py-[6px]" : "px-3 py-2"
          ...
          <div className="space-y-2 ">
            <div
              className={`bg-[#8633FF] text-white  ps-2 ${
                isSidebarOpen
                  ? "pe-[119px] py-[6px]"
