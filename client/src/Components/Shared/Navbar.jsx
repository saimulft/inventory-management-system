...
export default function Navbar() {
  return (
    <div className="flex items-center md:px-8 ps-3 pe-3 bg-[#2e2e30] text-white shadow-sm py-3 z-50">
            ...
            <ul className="menu pt-5 bg-[#2e2e30] text-base-content z-50">
              <div className="flex flex-col justify-between px-3 h-[100vh] z-50">
                <div className={`space-y-2 z-50`}>
                  ...
                  <NavLink to='/dashboard/home' className={({ isActive }) => isActive ? `bg-[#8633FF] text-white ps-3 pe-3 py-[10px] rounded-md flex items-center gap-2` : `bg-[#454547] text-white ps-3 pe-3 py-[10px] rounded-md flex items-center gap-2`}>
                ...
                <div className="bottom-0 mb-5 w-full">
                  <div className={`space-y-2 bottom-0`}>
                    <NavLink className={`bg-[#8633FF] text-white ps-3 pe-3 py-[10px] rounded-md flex items-center gap-2`}>
                      <BiSupport size={20} />
      ...
      <div className="text-lg font-medium w-full hidden md:block">Dashboard</div>
      ...
      <div className="w-full flex justify-end items-center md:gap-4 gap-2 z-[1]">
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-ghost btn-circle avatar w-12 border-2 border-[#8633FF]" >
