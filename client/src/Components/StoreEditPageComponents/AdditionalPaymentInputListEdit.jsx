...
export default function AdditionalPaymentInputListEdit({ storeDetails, from_index, isValidCardNumber, setIsValidCardNumber, isValidCardExp, setIsValidCardExp, isValidCardCvv, setIsValidCardCvv }) {
